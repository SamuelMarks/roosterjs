...
import ContentEditFeatures, { getDefaultContentEditFeatures, ContentEditFeature } from './ContentEditFeatures';
...
import { UnquoteWhenBackOnEmpty1stLine, UnquoteWhenEnterOnEmptyLine } from './features/quoteFeatures';
...
export default class ContentEdit implements EditorPlugin {
    ...
    constructor(featureSet?: ContentEditFeatures) {
        ...
        this.addFeature(featureSet.outdentWhenBackspaceOnEmptyFirstLine, OutdentWhenBackOn1stEmptyLine);
        ...
        this.addFeature(featureSet.unquoteWhenBackspaceOnEmptyFirstLine, UnquoteWhenBackOnEmpty1stLine);
